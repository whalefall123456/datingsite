...
//		String myAccount = "cqjava1701@163.com";
		String myAccount = "whalefallwebtest@163.com";
		//授权码
//		String myPass = "cq1701";
		String myPass = "OTOZUSLAQRAENPXF";
		//发件人 邮箱的 SMTP 服务器地址
	...
	private static MimeMessage createMsg(Session session, String myAccount, String username,String email,String code) {
		...
		try {
			//3.1发件人 from
			message.setFrom(new InternetAddress(myAccount, "派蒙", "utf-8"));
			...
			//3.3生成邮件主题
			message.setSubject("派蒙校园交友网站验证码","utf-8");
			...
			message.setContent(username+",您好<br>欢迎注册派蒙校园交友网站! 您的邮箱验证码为"+code,"text/html;charset=utf-8");
			//设置邮件的发送时间 是立即发送
