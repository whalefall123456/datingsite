!function (e, t) {
    ...
    return function (e) {
        ...
        function C(e, t, n, o) {
            var i = e.collections.sourceSizers, r = e.elements, s = r.sources, a = r.sourceAnimationWrappers,
                c = r.sourceMainWrappers, l = e.resolve;
            this.runActions = function () {
                s[t].classList.add(x), a[t].classList.add(g), c[t].removeChild(c[t].firstChild), i[t] = l(L, [t, n, o]), i[t].adjustSize()
            }
        }

        function F(e, t) {
            var n, o = this, i = e.elements.sources, r = e.props, s = e.resolve;
            this.handleImageLoad = function (e) {
                var t = e.target, n = t.width, o = t.height;
                a(n, o)
                ...
                var e = 1920, t = 1080;
                r.maxYoutubeDimensions && (e = r.maxYoutubeDimensions.width, t = r.maxYoutubeDimensions.height), a(e, t)
        ...
        function T(e, t) {
            var n = e.collections.sourcesLoadsHandlers, o = e.elements, i = o.sources, r = o.sourceAnimationWrappers,
                s = e.props.sources;
        ...
        function W(e, t) {
            var n = e.collections.sourcesLoadsHandlers, o = e.elements, r = o.sources, s = o.sourceAnimationWrappers,
                a = e.props.sources;
        ...
        function O(e, t) {
            var n = e.elements, o = n.sourceWrappersContainer, i = n.sourceMainWrappers;
        ...
        function q(e) {
            var t, n, o, i = e.collections.sourceMainWrappersTransformers, r = e.componentsServices, s = e.core,
        ...
        function J(e) {
            ...
            this.runActionsForEvent = function (e) {
                var t, a, c;
                n.container.contains(n.slideSwipingHoverer) || n.container.appendChild(n.slideSwipingHoverer), t = n.container, a = s, (c = t.classList).contains(a) || c.add(a), o.swipedX = _(e) - o.downClientX, r(i.current, "zero"), void 0 !== i.previous && o.swipedX > 0 ? r(i.previous, "negative") : void 0 !== i.next && o.swipedX < 0 && r(i.next, "positive")
            };
            var r = function (e, n) {
        ...
        function K(e) {
            var t = e.core.lightboxCloser, n = e.elements, o = e.resolve, i = e.slideSwipingProps, r = o(Z);
        ...
        function ee(e) {
            ...
            n = (t = e).core.classFacade, o = t.elements, n.removeFromEachElementClassIfContains = function (e, t) {
                ...
                var t = e.core, n = t.globalEventsController, o = t.windowResizeActioner, i = e.resolve, r = i(Y),
                    s = i(G), a = i(Q);
                ...
                o.listener = function (e) {
                    r.isSwiping = !0, r.downClientX = _(e), r.swipedX = 0, "VIDEO" === e.target.tagName || e.touches || e.preventDefault();
                    var t = i[s.current];
        ...
        function te(e) {
            ...
            n.isInitialized = !0, function (e) {
                ...
                for (var t = e.props.sources, n = e.resolve, o = n(w), i = n(M), r = n(H, [o, i]), s = 0; s < t.length; s++) if ("string" == typeof t[s]) {
